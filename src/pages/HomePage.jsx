  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-hidden bg-[#f5f0ed] dark:bg-gray-950">
      ...
      <div className="absolute inset-0 pointer-events-none dark:hidden">
        <div className="absolute -top-32 -left-32 w-[700px] h-[700px] rounded-full bg-[#fcd5c8]/60 blur-[120px]" />
        <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full bg-[#c9d6f5]/50 blur-[120px]" />
        <div className="absolute top-1/3 left-1/3 w-[500px] h-[500px] rounded-full bg-[#e8d5f0]/40 blur-[120px]" />
        <div className="absolute bottom-0 left-0 w-[600px] h-[500px] rounded-full bg-[#f0e0d0]/50 blur-[100px]" />
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[400px] rounded-full bg-[#d5dff5]/40 blur-[100px]" />
      </div>
      {/* Dark mode background */}
      <div className="absolute inset-0 pointer-events-none hidden dark:block">
        <div className="absolute -top-32 -left-32 w-[500px] h-[500px] rounded-full bg-indigo-950/30 blur-[120px]" />
        <div className="absolute top-0 right-0 w-[400px] h-[400px] rounded-full bg-purple-950/20 blur-[120px]" />
      </div>
